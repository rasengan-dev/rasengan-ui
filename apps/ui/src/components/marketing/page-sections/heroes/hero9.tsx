...
export const Hero9 = () => {
	return (
		<section className='w-full h-screen min-h-[600px] max-h-[1000px] flex items-end justify-center relative overflow-hidden'>
			<div className='absolute top-0 left-0 right-0 z-20 flex items-center justify-between px-4 lg:px-10 py-8 max-w-[1500px] mx-auto'>
				...
				<div className='flex gap-4'>
					<Button
						variant={"outline"}
						className='rounded-full border-white/30 backdrop-blur-sm bg-white/10 text-white/70 h-12'
					>
			...
			<div className='z-10 w-full flex flex-col items-center justify-end text-center px-4 pb-20'>
				...
				<h1 className='text-[40px] lg:text-[60px] leading-[50px] lg:leading-[60px] max-w-[700px] font-bold text-center text-white'>
					Where every stay becomes a memory
				</h1>
				<p className='text-sm text-center text-gray-300 max-w-[500px] mt-4'>
