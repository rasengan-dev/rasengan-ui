			...
			<div className='mt-20 w-full gap-4'>
				<div className='w-full flex items-center justify-between gap-2'>
					...
					<div className='flex items-center gap-2'>
						<Button
							variant='outline'
							className='bg-transparent text-foreground rounded-full px-4 py-2'
				...
				{!formOpen ? (
					<Accordion
						type='single'
						collapsible
						className='w-full mt-4 border rounded-xl px-4'
					>
					...
					<div
						className={cn(
							"mt-4 relative rounded-2xl border w-full h-auto bg-background dark:bg-input/70 mx-auto"
						)}
					>
						<div
							ref={messageRef}
							...
							className='w-full min-h-[155px] max-h-[300px] h-auto empty:before:content-[attr(data-placeholder)] empty:before:text-muted-foreground empty:before:absolute empty:before:pointer-events-none empty:before:inset-4 outline-0 text-foreground py-4 px-4 pb-4 overflow-auto rounded-2xl'
						></div>
