...
export const getApplicationUIComponents = (registryURL: string) => {
	const RASENGAN_REGISTRY_URL = registryURL;

	const applicationUIComponents: ComponentGroup[] = [
		// Cards components
		{
			label: "cards",
			name: "Cards",
...
Chakra-infused, responsive, and ready to drop into any React app — making it effortless for users to explore and interact with your content.`,
	...
	return applicationUIComponents;
}
