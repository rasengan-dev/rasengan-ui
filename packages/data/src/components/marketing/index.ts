...
export const getMarketingComponents = (registryURL: string) => {
	const RASENGAN_REGISTRY_URL = registryURL;

	const marketingComponents: ComponentGroup[] = [
			...
			componentsType: [
				{
					...
					components: [
						...
						{
							label: "hero-06",
							name: "Hero with centered text and image 1",
						...
						{
							label: "hero-07",
							name: "Hero with centered text and image 2",
						...
						{
							label: "hero-08",
							name: "Hero with centered text and image 3",
						...
						{
							label: "hero-11",
							name: "Hero with centered text and image 4",
						...
						{
							label: "hero-12",
							name: "Hero with centered text and image 5",
						...
						{
							label: "hero-13",
							name: "Hero with centered text and image 6",
						...
						{
							label: "hero-14",
							name: "Hero with centered text and image 7",
						...
						{
							label: "hero-15",
							name: "Hero with centered text and image 8",
						...
						{
							label: "hero-16",
							name: "Hero with centered text and image 9",
						...
						{
							label: "hero-17",
							name: "Hero with centered text and image 10",
...
Designed to convert, chakra-infused, and ready to drop into any React app — so your users see value at a glance.`,
					...
					components: [
						...
						{
							label: "pricing-02",
							name: "Pricing with centered text and tabs 1",
						...
						{
							label: "pricing-03",
							name: "Pricing with centered text and tabs 2",
