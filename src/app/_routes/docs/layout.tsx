      ...
      <div className='fixed top-0 left-0 right-0 z-30'>
        <Navbar />
          ...
          <div className='absolute left-0 bottom-0 bg-linear-to-t from-background to-transparent from-30% w-full h-[80px] z-20'></div>
				...
				<main ref={ref} className='flex-1 h-full overflow-y-auto [&_.rasengan-markdown-body]:!px-20 lg:[&_.rasengan-markdown-body]:!px-10 [&_.rasengan-wrapper_.rasengan-markdown-body]:!max-w-[1200px] [&_.rasengan-wrapper-with-toc_.rasengan-markdown-body]:!max-w-[1000px]'>
					<Outlet />
				</main>
			</section>
